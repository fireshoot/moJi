...
/**
 * @author yangxin
 * @类描述 : 监控sql耗时，在PageHelper的基础上添加的修改
...
public class SqlInterceptor extends SqlLogHandler implements Interceptor {

    protected Cache<String, MappedStatement> msCountMap = null;
    private Dialect dialect;
    private String defaultDialectClass = "dm.bp.finance.service.sql.advice.PageablePageHelper";
